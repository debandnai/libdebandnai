...
import com.merkaaz.app.databinding.HomeSnacksBrandedItemBinding
...
class HomeSnacksAdapter(
    ...
    RecyclerView.Adapter<HomeSnacksAdapter.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val listItem = HomeSnacksBrandedItemBinding.inflate(inflater, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.llItemLayout.setOnClickListener { v ->
            listener.onAdapterItemClick(productList, position, v, Constants.HOME_SNACKS)
        }
    }

    class ViewHolder(val binding: HomeSnacksBrandedItemBinding) :
        ...
        fun bind(
            ...
            binding.llItemLayout.setOnClickListener {
                adapter.listener.onAdapterItemClick(
                    ...
                    position,
                    it,
                    Constants.SNACKS_AND_BRANDED
                )
            }
            fragment.observeRecyclerviewData_snackbar(listItem)
