...
class SlideMenuMenuView @JvmOverloads constructor(
    context: Context?,
    ...
    private fun readAttributes(attributeSet: AttributeSet?) {
        val typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.SlideMenuView)
        try {
            mBackgroundDrawableId = typedArray.getResourceId(
                R.styleable.SlideMenuView_background,
                DEFAULT_DRAWABLE_ATTRIBUTE_VALUE
            )
            mHeaderViewId = typedArray.getResourceId(
                R.styleable.SlideMenuView_header,
                DEFAULT_LAYOUT_ATTRIBUTE_VALUE
            )
            mFooterViewId = typedArray.getResourceId(
                R.styleable.SlideMenuView_footer,
                DEFAULT_LAYOUT_ATTRIBUTE_VALUE
            )
        } finally {
            typedArray.recycle()
    ...
    private fun initialize() {
        val rootView = inflate(context, R.layout.slide_menu_view_menu, this) as ViewGroup
        ...
        if (view != null) {
            ...
            if (view is ViewGroup) {
                for (i in 0 until view.childCount) {
                    if (view.getChildAt(i) is AppCompatButton) {
    ...
    private fun handleOptions() {
        ...
        for (i in 0 until mAdapter!!.count) {
            ...
            if (optionView != null) {
                ...
                profile_tv = optionView.findViewById(R.id.profileTv)
    ...
    fun setFooterView(@LayoutRes footerViewId: Int) {
        ...
        mMenuViewHolder?.mMenuFooter?.isVisible = mFooterViewId != DEFAULT_LAYOUT_ATTRIBUTE_VALUE
        handleFooter()
    }
    ...
    private inner class MenuViewHolder internal constructor(rootView: ViewGroup) {
        ...
        init {
            mMenuOptions =
                rootView.findViewById<View>(R.id.slide_menu_view_menu_options_layout) as LinearLayout
            mMenuBackground =
                rootView.findViewById<View>(R.id.slide_menu_view_menu_background) as ImageView
            mMenuHeader =
                rootView.findViewById<View>(R.id.slide_menu_view_menu_header_layout) as ViewGroup
            mMenuFooter =
                rootView.findViewById<View>(R.id.slide_menu_view_menu_footer_layout) as ViewGroup
        }
    }
    ...
    interface OnMenuClickListener {
        ...
        /**
         * Will be called when user pressed login button view.
         */
        fun onLoginButtonClicked(position: Int, objectClicked: Any?)
    }
    ...
    companion object {
        ...
        @SuppressLint("ResourceType")
        @LayoutRes
        val DEFAULT_LAYOUT_ATTRIBUTE_VALUE = -54320
