...
import ie.healthylunch.app.utils.Constants.Companion.CULTURAL_CONSIDERATION
...
class CulturalConsiderationListAdapter(
    var activity: Activity,
    var allergenList: List<DataItem>,
    var listener: AdapterItemOnclickListener
) :
    RecyclerView.Adapter<CulturalConsiderationListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CulturalConsiderationListAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: CulturalConsiderationListAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(val binding: EditAllergyItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(position: Int) {
            ...
            val dataItem: ie.healthylunch.app.data.model.allergenListModel.DataItem = allergenList[position]
            ...
            binding.itemLayout.setOnClickListener {
               ...
               /* if (position == STATUS_ZERO) {
                ...
                listener.onAdapterItemClick(allergenList, position, CULTURAL_CONSIDERATION)
            }
