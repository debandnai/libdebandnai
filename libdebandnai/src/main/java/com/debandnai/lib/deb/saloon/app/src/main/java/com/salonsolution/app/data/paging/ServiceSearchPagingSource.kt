...
class ServiceSearchPagingSource(
    private val userApi: UserApi,
    private val serviceSearchRequest: JsonObject,
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ServicesList> {
        return try {
            ...
            serviceSearchRequest.addProperty("first", startPositionItemNumber)
            Log.d("tag", "paging request: $serviceSearchRequest")
