...
class StaffImageSlideAdapter(var images: ArrayList<StaffImages>, val listener: ImageSliderClickListener) :
    RecyclerView.Adapter<StaffImageSlideAdapter.ImageSliderViewHolder>() {
