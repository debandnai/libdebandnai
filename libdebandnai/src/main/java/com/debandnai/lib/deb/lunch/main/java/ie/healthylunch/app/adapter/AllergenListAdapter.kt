...
class AllergenListAdapter(
    var activity: Activity,
    var allergenList: List<DataItem>,
    var listener: AdapterItemOnclickListener
) :
    RecyclerView.Adapter<AllergenListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AllergenListAdapter.ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val listItem = EditAllergyItemBinding.inflate(inflater, parent, false)
        return ViewHolder(listItem)
    }

    override fun onBindViewHolder(holder: AllergenListAdapter.ViewHolder, position: Int) {
        ...
        fun bind(position: Int) {
           val dataItem: DataItem = allergenList[position]
            ...
            binding.itemLayout.setOnClickListener {
                ...
                listener.onAdapterItemClick(allergenList, position, ALLERGEN_LIST)
            }
