...
import com.merkaaz.app.databinding.FragmentPrivacyPolicyBinding
...
class PrivacyPolicyFragment : BaseFragment() {
    ...
    private fun viewOnClick() {
        binding.btnOk.setOnClickListener{
            activity?.let { it.startActivity(
                Intent(it, DashBoardActivity::class.java).addFlags(
    ...
    override fun onResume() {
        ...
        dashboardViewModel.headerText.value = getString(R.string.privacy_policy)
