...
import com.merkaaz.app.databinding.HomeFeaturedProductsItemBinding
...
class HomeFeaturedAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val listItem = HomeFeaturedProductsItemBinding.inflate(inflater, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.llItemLayout.setOnClickListener { v ->
            listener.onAdapterItemClick(productList, position, v, Constants.HOME_FEATURED_CATEGORY)
        }
    }

    class ViewHolder(val binding: HomeFeaturedProductsItemBinding) :
        ...
        fun bind(
            ...
            binding.llItemLayout.setOnClickListener {
                adapter.listener.onAdapterItemClick(
                    ...
                    position,
                    it,
                    Constants.FEATURED_PRODUCT
                )
            }
            fragment.observeRecyclerviewData_homefeaturedata(listItem)
